...
data class DepartmentDetailResponseDto(
        @SerialName("data") val data: DepartmentDetailDataDto,
...
data class DepartmentDetailDataDto(
        ...
        @SerialName("bmu_id") val bmuId: Int,
        @SerialName("name") val name: String,
        @SerialName("short_name") val shortName: String,
        @SerialName("director") val director: DirectorDto? = null,
        @SerialName("faculty") val faculty: List<FacultyDto>,
        @SerialName("gallery") val gallery: List<GalleryItemDto>,
        @SerialName("infrastructure") val infrastructure: List<InfrastructureItemDto>,
        @SerialName("placement") val placement: List<PlacementMemberDto>,
        @SerialName("programs") val programs: Map<String, ProgramDto>,
        @SerialName("students_recruited") val studentsRecruited: List<StudentRecruitedDto>
)
...
data class StudentRecruitedDto(
        ...
        @SerialName("sr_no") val srNo: String,
...
fun InfrastructureItemDto.toDomain() = InfrastructureItem(images = images, title = title)

fun PlacementMemberDto.toDomain() =
        PlacementMember(
                designation = designation,
                email = email,
                name = name,
...
fun ProgramDto.toDomain() =
        Program(description = description, semesters = semesters.map { it.toDomain() })

fun SemesterDto.toDomain() =
        Semester(semester = semester, subjects = subjects.map { it.toDomain() })

fun SubjectDto.toDomain() = Subject(subjectCode = subjectCode, subjectName = subjectName)

fun StudentRecruitedDto.toDomain() =
        StudentRecruited(
